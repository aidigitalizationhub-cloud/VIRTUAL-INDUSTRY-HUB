...
export const PartnerOverviewPage: React.FC<{ user: User | null; setActiveTab?: (tab: DashboardTab) => void }> = ({ user, setActiveTab }) => {
  ...
  return (
    <div className="space-y-6">
       <UnifiedDashboardProfile user={user} onAction={() => setIsCreateModalOpen(true)} actionLabel={t('dashboard.postNewChallenge')} />
