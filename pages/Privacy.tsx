      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="prose prose-lg text-gray-600 max-w-none space-y-8 font-medium">
            ...
            <section>
              <h2 className="text-2xl font-bold text-ug-navy mb-4 flex items-center gap-2"><Lock size={20} className="text-ug-teal" /> Data Protection Overview</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-ug-navy mb-4 flex items-center gap-2"><Eye size={20} className="text-ug-teal" /> Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-ug-navy mb-4 flex items-center gap-2"><Server size={20} className="text-ug-teal" /> How We Use Your Data</h2>
