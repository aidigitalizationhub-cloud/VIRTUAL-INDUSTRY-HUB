    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col h-full justify-center">
          <div className="md:w-2/3 mt-6 sm:mt-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/projects" className="bg-ug-teal text-white px-7 py-3 sm:px-9 sm:py-3.5 rounded-xl font-semibold text-xs sm:text-sm tracking-wide hover:bg-white hover:text-ug-teal transition-all shadow-lg flex items-center gap-2 sm:gap-3">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-ug-navy tracking-tight"><Tr text="Accelerating Regional Health" /></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between text-white">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2 tracking-tight"><Tr text="Diagnostics" /></h3>
                  ...
                  <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-ug-teal group-hover:text-white transition-colors">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between text-white">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2 tracking-tight"><Tr text="Pharmaceutical" /></h3>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between text-white">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2 tracking-tight"><Tr text="Vaccines" /></h3>
                  ...
                  <div className="flex items-center gap-2 text-xs font-semibold tracking-wide text-ug-teal group-hover:text-white transition-colors">
                    <Tr text="View Pipeline" /> <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform duration-300" />
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-50 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-12">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-ug-navy tracking-tight"><Tr text="Market-Ready Innovations" /></h2>
               ...
               {marketReadyProducts.map(product => (
                 <div key={product.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col md:flex-row hover:shadow-xl transition group">
                   ...
                   <div className="p-6 md:w-3/5 flex flex-col justify-center">
                      ...
                      <button onClick={() => navigate(`/projects/${product.id}`)} className="self-start text-xs font-bold text-ug-navy border-b-2 border-ug-navy pb-1 hover:text-ug-teal hover:border-ug-teal transition uppercase tracking-wide"><Tr text="Detail Brief" /></button>
                   </div>
                 </div>
               ))}
             </div>
      ...
      <section className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-12">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-ug-navy tracking-tight"><Tr text="Active Research Pipeline" /></h2>
              ...
              <Link to="/projects" className="text-xs font-bold text-ug-teal uppercase tracking-wide flex items-center gap-2 hover:text-ug-navy transition-colors">
               ...
               {showcaseProjects.map(project => (
                 <div key={project.id} className="bg-gray-50 rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition flex flex-col h-full group">
                   ...
                   <div className="p-6 flex-1 flex flex-col justify-between">
                     <div>
                       <span className="text-[11px] font-bold text-gray-400 tracking-wide block mb-2"><Tr text={project.department} /></span>
                       <h3 className="text-xl font-bold text-gray-900 mb-3 leading-tight group-hover:text-ug-teal transition-colors line-clamp-2"><Tr text={project.title} /></h3>
                       <p className="text-gray-500 text-xs font-medium leading-relaxed mb-6 line-clamp-3"><Tr text={project.description} /></p>
                     </div>
                     <button onClick={() => navigate(`/projects/${project.id}`)} className="w-full py-3.5 bg-ug-navy text-white text-[11px] font-semibold tracking-wide rounded-xl hover:bg-ug-teal transition flex items-center justify-center gap-2">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-12">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-ug-navy tracking-tight"><Tr text="Discovery Feed" /></h2>
              ...
              <Link to="/news" className="text-xs font-bold text-ug-navy uppercase tracking-wide flex items-center gap-2 hover:text-ug-teal transition-colors">
                   ...
                   <div className="p-6 flex-1 flex flex-col justify-between">
                     <div>
                       <div className="flex items-center gap-3 mb-3">
                         ...
                         <span className="text-[11px] font-bold text-gray-400 tracking-wide flex items-center gap-1">
                           <Calendar size={12} /> {item.published_at}
                         </span>
                       </div>
                       <h3 className="text-lg font-bold text-gray-900 mb-3 leading-tight group-hover:text-ug-teal transition-colors line-clamp-2"><Tr text={item.title} /></h3>
                       <p className="text-gray-500 text-xs font-medium leading-relaxed mb-6 line-clamp-3"><Tr text={item.summary} /></p>
                     </div>
                     <span className="text-[11px] font-semibold text-ug-teal tracking-wide group-hover:translate-x-2 transition-transform inline-flex items-center gap-1.5 mt-auto">
