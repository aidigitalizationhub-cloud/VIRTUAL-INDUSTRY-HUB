      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-[3rem] p-12 shadow-sm border border-gray-100">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-4xl font-bold text-ug-navy">Terms of Service</h1>
          </div>
          ...
          <div className="prose prose-lg text-gray-600 max-w-none space-y-8 font-medium">
            ...
            <section>
              <h2 className="text-2xl font-bold text-ug-navy mb-4 flex items-center gap-2"><Award size={20} className="text-ug-teal" /> Intellectual Property (IP) Ownership</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-ug-navy mb-4 flex items-center gap-2"><FileText size={20} className="text-ug-teal" /> Non-Disclosure Agreement (NDA)</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-ug-navy mb-4 flex items-center gap-2"><Gavel size={20} className="text-ug-teal" /> Conflict of Interest</h2>
            ...
            <div className="p-8 bg-gray-900 text-white rounded-2xl shadow-xl">
              <p className="text-sm font-bold uppercase tracking-wide text-ug-teal mb-2">Legal Jurisdiction</p>
